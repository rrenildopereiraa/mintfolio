...
export const viewport: Viewport = {
	// Two values, so the address bar on a phone matches whichever palette the
...
export default function RootLayout({ children }: { children: ReactNode }) {
	return (
		// `suppressHydrationWarning` because the inline script below rewrites the
		// class on <html> before React hydrates, which is the whole point.
