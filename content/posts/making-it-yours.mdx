...
There is no strip of social icons anywhere, on purpose. A grouped row of logos reads as a widget rather than as something you wrote, and unlabelled glyphs make the reader decode them one at a time.
